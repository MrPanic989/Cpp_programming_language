...
There, the initial data of our ego vehicle is stored in ego_data.json, and the data of the other
vehicles is stored in vehicle_data.json.
...
Instead of generating the data by just random numbers, you have to load the JSON data and fill it into
the vehicles and ego_vehicle struct.
- init_ego_vehicle
