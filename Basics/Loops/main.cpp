...
int main(void)
{
    uint32_t max_number_of_attempts = 3u;
    uint32_t current_number_of_attempts = 0u;

    //Now we created a 'for-loop' where the user has maximum 3 attempts to guess the right number
